...
(function (global) {
  ...
  const QUERY = `{
    "products": *[_type == "product"]{
      ...
      price,
      "mrp": coalesce(originalPrice, price),
      sku,
      stock,
      "rating": coalesce(rating, 0),
      "reviewCount": coalesce(totalReviews, 0),
      "sizes": coalesce(sizes, []),
      "colors": coalesce(colors[]{name, hex}, []),
      "images": coalesce(images[].image.asset->url, []),
      shortDescription,
      ...
      "reviews": coalesce(reviews[]{author, rating, title, comment, date, verified}, [])
    },
